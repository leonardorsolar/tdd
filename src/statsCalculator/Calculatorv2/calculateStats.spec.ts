...
describe('stats calculator', () => {
  it('returns "minValue", "maxValue", "numElements", "averageValue"', () => {
    const response = calculateStats([2, 4, 21, -8, 53, 40]);
